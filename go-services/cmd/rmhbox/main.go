...
func main() {
	...
	// the real user-facing path (the edge already routes /rmhbox-ws/* here). The
	// exact "/rmhbox-ws/health" pattern wins over the "/rmhbox-ws/" subtree.
	mux.HandleFunc("/rmhbox-ws/health", httpx.Health("rmhbox", nil))
