...
Generated from `lib/games.ts`, the single source of truth every card on the site reads from.
...
| **Versecraft** | [`/versecraft`](https://rmhstudios.com/versecraft) | — | — | `Visual Novel` `AI-Generated` `Romance` `Poetry` |
...
| **CookGame** | [`/cookgame`](https://rmhstudios.com/cookgame) | — | — | `Simulation` `Tycoon` `Crime` |
| **Mental-Hospital: Rochester Offensive** | [`/rochester-offensive`](https://rmhstudios.com/rochester-offensive) | — | — | `FPS` `Multiplayer` `Tactical` `3D` |
...
**Route:** `/rmhbox` · **Catalog id:** `rmhbox` · **Status:** Playable · **Sign-in:** required
...
**Route:** `/altair` · **Catalog id:** `altair` · **Sign-in:** required
...
**Route:** `/versecraft` · **Catalog id:** `versecraft` · **Sign-in:** not required
...
**Route:** `/slice-it` · **Catalog id:** `slice-it` · **Sign-in:** required
...
**Route:** `/velum2099` · **Catalog id:** `velum2099` · **Sign-in:** not required

### Synapse Storm

Juggle a storm of micro-challenges. Stay sharp. See how long your mind can keep up before the load becomes too great.

**Route:** `/synapse-storm` · **Catalog id:** `synapse-storm` · **Sign-in:** required
...
**Route:** `/forest-explorer` · **Catalog id:** `forest-explorer` · **Sign-in:** not required
...
**Route:** `/void-breaker` · **Catalog id:** `void-breaker` · **Sign-in:** required
...
**Route:** `/kowloon-knockout` · **Catalog id:** `kowloon-knockout` · **Sign-in:** not required
...
**Route:** `/cookgame` · **Catalog id:** `cookgame` · **Sign-in:** not required

### Mental-Hospital: Rochester Offensive
...
**Route:** `/rochester-offensive` · **Catalog id:** `rochester-offensive` · **Sign-in:** not required
...
**Route:** `/house-always-wins` · **Catalog id:** `house-always-wins` · **Sign-in:** required
...
**Route:** `/dream-rift` · **Catalog id:** `dream-rift` · **Sign-in:** not required

### RMH Farming Simulator
...
**Route:** `/nightrail` · **Catalog id:** `nightrail` · **Status:** Playable · **Sign-in:** required
