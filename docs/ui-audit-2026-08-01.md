...
- **10 remain**: four where a state genuinely moves layout (`left: calc(…)`, a
  toggle knob, a cell-size grid) and six where the change comes from a dynamic
  className a static read cannot resolve. Listed rather than guessed at.
