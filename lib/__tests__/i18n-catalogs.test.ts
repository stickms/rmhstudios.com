...
const KNOWN_UNTRANSLATED: Record<string, string[]> = {
  ...
  feed: [
    ...
    'edit-history-unavailable-detail',
    'image-over-limit_one',
    'image-over-limit_other',
    'image-too-large',
    'image-unsupported',
    'post-queued',
    'tag-post-count_one',
    'tag-post-count_other',
  ...
  'r-slice-it': [
    ...
    'apply-offset-early',
    'apply-offset-late',
    'artist-play-count_one',
    'artist-play-count_other',
    'best-delta-down',
    'best-delta-up',
    'gauge',
    'gauge-bonus-lost',
    ...
    'lamp-perfect',
    'misses-for-grade',
    'pack-track-count_one',
    'pack-track-count_other',
    'plus-more-tracks_one',
    'plus-more-tracks_other',
    'ranked-charts-chip_one',
    'ranked-charts-chip_other',
    'ranked-charts-tooltip_one',
    'ranked-charts-tooltip_other',
    'setlist-liked-count_one',
    'setlist-liked-count_other',
    'setlist-missing_one',
    'setlist-missing_other',
    'timing-bias',
    'timing-early',
    'timing-late',
    'unstable-rate',
  ...
  // through `pnpm i18n:extract`, so they existed only as inline
  // `defaultValue`s and never reached locales/ at all. Extracting them is
  // the fix; these are the resulting gaps in the fifteen shipped
  // non-English catalogs.
  //
  // They are listed here rather than filled with English on purpose. The
  // extractor writes the English default into EVERY locale for a new key,
  // and `keysToTranslate` (lib/i18n/diff.ts) only picks up keys MISSING
  // from the target — so an English-filled key is one the translator can
  // never revisit. Leaving the gap is what lets `i18n-translate` (which
  // fires on any push touching locales/en/**) actually translate them.
  ...
  'c-bums-rush': [
    ...
    'cta.settings',
    'cta.wardrobe',
    'hud.announce-deaths_one',
    'hud.announce-deaths_other',
    'hud.announce-objectives_one',
    'hud.announce-objectives_other',
    'hud.canvas-label_one',
    'hud.canvas-label_other',
    'hud.objective-done',
    'hud.objectives',
    'hud.offscreen',
    'hud.pause',
    ...
    'level.fallback-name',
    'level.loading',
    'level.needs-two-note',
    'level.objectives',
    'level.objectives-blurb',
    'level.par',
    'level.play',
    'level.players',
    'lobby.code-label',
    ...
    'settings.controls',
    'settings.deadzone',
    'settings.deadzone-hint',
    'settings.music',
    'settings.pad-brand',
    'settings.pad-brand-hint',
    'settings.remap',
    'settings.rumble',
    'settings.saturation',
    'settings.saturation-hint',
    'settings.sfx',
    'settings.tags',
    'settings.tags-hint',
    'settings.title',
    'settings.touch-auto',
    'settings.touch-auto-hint',
    'settings.touch-scheme',
    'settings.touch-two-stick',
    'settings.touch-two-stick-hint',
    'settings.ui-volume',
    'touch.drop',
    'touch.emote',
    'touch.grab-left',
  ...
  'c-roadmap': [
    ...
    'request-note-too-long',
    'request-note-too-short',
    'request-official-reply',
    'request-save',
    'request-save-failed',
    'request-saved',
