...
const KNOWN_UNWRAPPED: readonly string[] = [
  ...
  'app/routes/api/slice-it/songs/cover/$filename.ts',
...
const KNOWN_BYPASSES_WRAPPER: readonly string[] = [
  ...
  'app/routes/api/slice-it/songs/$id/play.ts',
  'app/routes/api/slice-it/songs/stream/$id.ts',
