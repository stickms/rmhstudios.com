...
export const SOURCES: SourceDef[] = [
  ...
  // ── Radiant tier (post-Omega) — for Ascended players chasing the Sun ──
  {
    id: 'radiantSpring',
    name: 'Radiant Spring',
    tagline: 'Water that remembers being sunlight.',
    icon: '⛲',
    baseCost: 1e84,
    baseHPS: 3e80,
    costMultiplier: 1.07,
  ...
  },
  {
    id: 'sunforge',
    name: 'Sunforge',
    tagline: 'Where new mornings are hammered into shape.',
    icon: '🔆',
    baseCost: 5e87,
    baseHPS: 1.5e84,
    costMultiplier: 1.07,
  ...
  {
    id: 'joyConstellation',
    name: 'Joy Constellation',
    tagline: 'You drew your own stars and they agreed to shine.',
    icon: '✨',
    baseCost: 2e91,
    baseHPS: 6e87,
    costMultiplier: 1.07,
  ...
  },
  {
    ...
    tagline: 'Before joy had a name, it had this light.',
    icon: '🌅',
    baseCost: 1e95,
    baseHPS: 3e91,
    costMultiplier: 1.07,
  ...
  },
  {
    id: 'infinitePrism',
    name: 'Infinite Prism',
    tagline: 'One ray of joy, split into every colour that exists.',
    icon: '🔮',
    baseCost: 5e98,
    baseHPS: 1.5e95,
    costMultiplier: 1.06,
    requiresPrestige: 100,
  },
  {
    id: 'edenEngine',
    name: 'Eden Engine',
    tagline: 'It manufactures paradise on a continuous loop.',
    icon: '🌳',
    baseCost: 3e102,
    baseHPS: 1e99,
    costMultiplier: 1.06,
    requiresPrestige: 110,
  },
];
