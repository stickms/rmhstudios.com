...
export const RT_COMMON_POINTS = 20;
export const RT_UNCOMMON_POINTS = 50;
export const RT_RARE_POINTS = 90;
export const RT_MULTI_SYLLABLE_BONUS = 20;
export const RT_SPEED_BONUS = 10;
export const RT_INVALID_PENALTY = -10;
...
export const SS_TILES_ADDED_PER_ROUND = 2;
...
export const SS_CORRECT_TAP_POINTS = 10;
export const SS_FIRST_FINISH_BONUS = 25;
...
export const HK_RESHUFFLE_INTERVAL_SECONDS = 20;
export const HK_RESHUFFLE_WARNING_SECONDS = 3;
export const HK_SPACE_DELAY_MS = 200;
export const HK_INPUT_RATE_LIMIT = 5;
export const HK_EFFECTIVE_SPEED_MULTIPLIER = 100;
export const HK_FIRST_FINISH_BONUS = 50;
