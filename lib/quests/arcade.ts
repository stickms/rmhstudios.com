...
const POOL: ArcadeChallengeDef[] = [
  { game: 'laundry-sort', title: 'Score 4,000 in Laundry Sort', metric: 'score', target: 4000, xp: 50, coins: 12 },
  { game: 'laundry-sort', title: 'Play 2 rounds of Laundry Sort', metric: 'plays', target: 2, xp: 40, coins: 10 },
  { game: 'void-breaker', title: 'Score 8,000 in Void Breaker', metric: 'score', target: 8000, xp: 60, coins: 15 },
  { game: 'void-breaker', title: 'Clear 5 waves in Void Breaker', metric: 'clear', target: 5, xp: 55, coins: 14 },
  { game: 'kowloon-knockout', title: 'Win a Kowloon Knockout brawl', metric: 'win', target: 1, xp: 60, coins: 16 },
  { game: 'neon-driftway', title: 'Score 6,000 in Neon Driftway', metric: 'score', target: 6000, xp: 55, coins: 14 },
  { game: 'slice-it', title: 'Score 5,000 in Slice It!', metric: 'score', target: 5000, xp: 50, coins: 12 },
  { game: 'synapse-storm', title: 'Score 3,000 in Synapse Storm', metric: 'score', target: 3000, xp: 50, coins: 12 },
  { game: 'dream-rift', title: 'Clear 2 stages in Dream Rift', metric: 'clear', target: 2, xp: 60, coins: 16 },
  { game: 'dream-rift', title: 'Score 50,000 in Dream Rift', metric: 'score', target: 50000, xp: 65, coins: 18 },
  { game: 'velum2099', title: 'Bank 5,000 credits in VELUM2099', metric: 'score', target: 5000, xp: 55, coins: 14 },
  { game: 'rochester-offensive', title: 'Win a round in Rochester Offensive', metric: 'win', target: 1, xp: 65, coins: 18 },
  { game: 'temple-of-joy', title: 'Play Temple of Joy today', metric: 'plays', target: 1, xp: 40, coins: 10 },
];
