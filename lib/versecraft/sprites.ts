...
const SPRITE_FILES: Record<string, string[]> = {
  ...
  luna:  ['normal', 'smile', 'happy', 'sad', 'angry', 'smirk', 'annoyed', 'shocked', 'sleepy', 'smile2', 'laugh'],
  sable: ['normal', 'smile', 'happy', 'sad', 'angry', 'smirk', 'annoyed', 'shocked', 'sleepy', 'smile2', 'laugh'],
  wren:  ['normal', 'smile', 'happy', 'sad', 'angry', 'smirk', 'annoyed', 'shocked', 'sleepy', 'smile2', 'laugh'],
  kai:   ['normal', 'smile', 'happy', 'sad', 'angry', 'smirk', 'annoyed', 'shocked', 'sleepy', 'smile2', 'laugh'],
  // Halfbody (Sutemo Female) - 16 expressions
  rowan: ['normal', 'smile', 'smile2', 'smile3', 'happy', 'happy2', 'awkward', 'smirk', 'sad', 'sad2', 'annoyed', 'annoyed2', 'surprised', 'surprised2', 'angry', 'scared'],
  // Male (Sutemo Male) - 11 expressions
  milo:  ['normal', 'smile', 'smile2', 'smile3', 'laugh', 'surprised', 'smirk', 'angry', 'angry2', 'sad', 'sweat'],
  // Mature (Anime Mature Woman) - 16 expressions
  teacher: ['normal', 'smile', 'smile2', 'happy', 'happy2', 'sad', 'crying', 'angry', 'angry2', 'smirk', 'smirk2', 'annoyed', 'shocked', 'oh', 'sleepy', 'sleepy2'],
};
...
const FULL_BODY_MAP: Record<string, string> = {
  neutral: 'normal', normal: 'normal', composed: 'normal',
  contemplative: 'sleepy', melancholy: 'sad',
  tender_smile: 'smile', slight_smile: 'smile2', genuine_smile: 'happy',
  analytical: 'annoyed', smirk: 'smirk',
  disapproving: 'annoyed', manic_grin: 'laugh',
  intense: 'angry', frustrated: 'angry',
  happy: 'happy', sad: 'sad', angry: 'angry',
  blush: 'smile2', talk: 'smile',
  shocked: 'shocked', sleepy: 'sleepy', laugh: 'laugh',
};
...
const EXPRESSION_MAP: Record<string, Record<string, string>> = {
  ...
  rowan: {
    neutral: 'normal', normal: 'normal', composed: 'normal',
    contemplative: 'awkward', melancholy: 'sad',
    tender_smile: 'smile', slight_smile: 'smile2', genuine_smile: 'happy',
    analytical: 'surprised', smirk: 'smirk',
    disapproving: 'annoyed', manic_grin: 'smile3',
    intense: 'angry', frustrated: 'annoyed2',
    happy: 'happy', sad: 'sad', angry: 'angry',
    blush: 'smile2', talk: 'smile', surprised: 'surprised',
    shocked: 'surprised2', sleepy: 'sad2', laugh: 'happy2',
    awkward: 'awkward', scared: 'scared',
  },
  milo: {
    neutral: 'normal', normal: 'normal', composed: 'normal',
    contemplative: 'normal', melancholy: 'sad',
    tender_smile: 'smile', slight_smile: 'smile2', genuine_smile: 'smile3',
    analytical: 'normal', smirk: 'smirk',
    disapproving: 'angry', manic_grin: 'laugh',
    intense: 'angry2', frustrated: 'angry',
    happy: 'smile', sad: 'sad', angry: 'angry',
    blush: 'sweat', talk: 'smile', surprised: 'surprised',
    shocked: 'surprised', sleepy: 'sad', laugh: 'laugh',
    sweat: 'sweat',
  },
  teacher: {
    neutral: 'normal', normal: 'normal', composed: 'normal',
    ...
    tender_smile: 'smile', slight_smile: 'smile2', genuine_smile: 'happy',
    analytical: 'annoyed', smirk: 'smirk',
    disapproving: 'annoyed', manic_grin: 'smirk2',
    intense: 'angry', frustrated: 'angry2',
    happy: 'happy', sad: 'sad', angry: 'angry',
    blush: 'smile2', talk: 'smile', surprised: 'shocked',
    shocked: 'shocked', sleepy: 'sleepy', laugh: 'happy2',
    crying: 'crying', oh: 'oh',
  },
};
