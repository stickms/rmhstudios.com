...
export const apps: AppInfo[] = [
    ...
    },
    {
        id: 'rmh-docs',
        title: 'RMH Docs',
        description: 'A collaborative word processor. Create and edit documents in real-time with others.',
        longDescription:
            'RMH Docs is a full-featured collaborative word processor. Write with rich formatting, insert tables, images, and code blocks. Share documents with collaborators and edit together in real-time with live cursors and presence awareness.',
        href: '/rmhdocs',
        status: 'Beta',
        cta: 'Open Docs',
        isSteam: false,
        ...
        tags: ['Documents', 'Collaboration', 'Beta'],
        imagePath: '/images/games/rmhdocs.png',
        authGate: true,
    },
    {
        id: 'rmh-sheets',
        title: 'RMH Sheets',
        description: 'A collaborative spreadsheet editor. Crunch numbers together in real-time.',
        longDescription:
            'RMH Sheets is a full-featured collaborative spreadsheet with formulas, formatting, charts, and multi-sheet support. Share spreadsheets with collaborators and edit cells simultaneously with real-time sync.',
        href: '/rmhsheets',
        status: 'Beta',
        cta: 'Open Sheets',
        isSteam: false,
        ...
        iconName: 'Sheet',
        color: 'from-green-500/20 to-teal-500/20 hover:border-green-500/50',
        tags: ['Spreadsheet', 'Collaboration', 'Beta'],
        imagePath: '/images/games/rmhsheets.png',
        authGate: true,
    },
    {
        id: 'rmh-slides',
        title: 'RMH Slides',
        description: 'A collaborative slideshow editor. Build presentations together in real-time.',
        longDescription:
            'RMH Slides is a full-featured collaborative presentation editor. Add text, images, and shapes to slides, apply themes and transitions, and present with a built-in presenter mode. Collaborate in real-time with live element selection.',
        href: '/rmhslides',
        status: 'Beta',
        cta: 'Open Slides',
        isSteam: false,
        ...
        color: 'from-yellow-500/20 to-red-500/20 hover:border-yellow-500/50',
        tags: ['Presentations', 'Collaboration', 'Beta'],
        imagePath: '/images/games/rmhslides.png',
        authGate: true,
    },
];
