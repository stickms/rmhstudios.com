...
export const interactables: InteractableDefinition[] = [
    ...
    {
        id: 'act1_journal_warden_note',
        act: 'act1',
        type: 'journal_item',
        label: 'Note Nailed to a Trunk',
        position: [2.5, 0.9, -18],
        revealMethod: 'always_visible',
        interactionRadius: 3,
        journalEntryId: 'act1_warden_note',
    },
    {
        id: 'act1_journal_history',
        act: 'act1',
        type: 'journal_item',
        label: 'Weathered Ranger Plaque',
        position: [-7, 0.6, 7],
        revealMethod: 'flashlight_only',
        interactionRadius: 3,
        journalEntryId: 'act1_history_forest',
    },
    {
        id: 'act1_journal_biolum',
        act: 'act1',
        type: 'journal_item',
        label: 'Glowing Mushroom Ring',
        position: [4, 0.2, -35],
        revealMethod: 'proximity',
        interactionRadius: 4,
        journalEntryId: 'act1_bioluminescence',
    },
    {
        id: 'act1_journal_cache',
        act: 'act1',
        type: 'journal_item',
        label: 'Hollow Stone Cache',
        position: [-8, 0.3, 27],
        revealMethod: 'flashlight_only',
        interactionRadius: 3,
        journalEntryId: 'act1_hidden_cache',
    },
    ...
    {
        id: 'act2_journal_warden',
        act: 'act2',
        type: 'journal_item',
        label: 'Torn Warden Note',
        position: [2, 0.7, -12],
        revealMethod: 'always_visible',
        interactionRadius: 3,
        journalEntryId: 'act2_warden_warning',
    },
    {
        id: 'act2_journal_hollow',
        act: 'act2',
        type: 'journal_item',
        label: 'Carved Heartwood Pipes',
        position: [-4, 0.6, -33],
        revealMethod: 'flashlight_only',
        interactionRadius: 3,
        journalEntryId: 'act2_hollow_heart',
    },
    ...
    {
        id: 'act3_journal_warden_pack',
        act: 'act3',
        type: 'journal_item',
        label: 'The Warden\'s Pack',
        position: [36, 0.3, -65],
        revealMethod: 'proximity',
        interactionRadius: 4,
        journalEntryId: 'act3_warden_farewell',
    },
    {
        id: 'act3_journal_dream',
        act: 'act3',
        type: 'journal_item',
        label: 'Living Bark',
        position: [44, 0.9, -74],
        revealMethod: 'flashlight_only',
        interactionRadius: 3,
        journalEntryId: 'act3_heartwood_dream',
    },
