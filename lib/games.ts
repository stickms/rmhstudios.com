...
export const games: GameInfo[] = [
  {
    ...
    title: 'Isleworks',
    description:
      'A relaxing isometric city builder on a floating pastel island. Lay roads, grow a city, keep everyone happy.',
    longDescription:
    ...
    iconName: 'Building2',
    color: 'from-sky-400/20 to-emerald-400/20 hover:border-sky-400/50',
    tags: ['City Builder', 'Strategy', 'Relaxing', 'Isometric'],
    authGate: false,
  },
  {
    id: 'rmhbox',
  ...
  },
  {
    ...
    title: 'Temple of Joy',
    description:
      'A golden idle clicker about building an unreasonable amount of gladness, one Acolyte at a time.',
    longDescription:
    ...
    iconName: 'Sun',
    color: 'from-amber-400/20 to-yellow-300/20 hover:border-amber-400/50',
    tags: ['Idle', 'Clicker', 'Prestige', 'Minigames'],
  ...
  },
  {
    ...
    description:
      'A neon 3D brawler set in 90s Hong Kong — pixel-shaded stick fighters, combos, and up to 4-player FFA or team battles.',
    longDescription:
  ...
  },
  {
    ...
    title: 'Massive March',
    description:
      'A long walk across a handcrafted island, alone or with up to eleven friends, where every puzzle is really a problem of telling somebody what you can see.',
    longDescription:
    ...
    cta: 'Start Walking',
    isSteam: false,
    gradient: 'from-amber-300 to-sky-600',
    iconName: 'Footprints',
    color: 'from-amber-300/20 to-sky-600/20 hover:border-amber-300/50',
    tags: ['Multiplayer', 'Co-op', '3D', 'Exploration', 'Puzzle'],
    imagePath: '/images/games/massive-march.webp',
    authGate: true,
  },
];
