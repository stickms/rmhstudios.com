...
const nextConfig: NextConfig = {
  // ─── Performance: Tree-shake barrel exports for heavy packages ───
  // This dramatically reduces client bundle size by only importing
  // the specific modules used rather than entire libraries.
  ...
  experimental: {
    // Optimized chunking strategy for better long-term caching
