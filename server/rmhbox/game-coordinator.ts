...
import { PixelPushersMinigame } from './minigames/pixel-pushers';
import { ScrollSoulMinigame } from './minigames/scroll-soul';
...
>([
  ...
  ['pixel-pushers', PixelPushersMinigame],
  ['scroll-soul', ScrollSoulMinigame],
]);
