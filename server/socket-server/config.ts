...
export const config = {
  ...
  SOCKET_RATE_LIMITS: {
    ...
    'holdem:list_rooms':      { max: 20,  windowMs: 60_000 },
    'holdem:create_room':     { max: 3,   windowMs: 60_000 },
    'holdem:join_room':       { max: 10,  windowMs: 60_000 },
    'holdem:leave_room':      { max: 10,  windowMs: 60_000 },
    'holdem:update_room':     { max: 20,  windowMs: 60_000 },
    'holdem:fold':            { max: 60,  windowMs: 60_000 },
    'holdem:check':           { max: 60,  windowMs: 60_000 },
    'holdem:call':            { max: 60,  windowMs: 60_000 },
    'holdem:raise':           { max: 60,  windowMs: 60_000 },
    'holdem:all_in':          { max: 30,  windowMs: 60_000 },
    'holdem:sit_in':          { max: 20,  windowMs: 60_000 },
    'holdem:sit_out':         { max: 20,  windowMs: 60_000 },
    'holdem:rebuy':           { max: 20,  windowMs: 60_000 },
    'holdem:show_cards':      { max: 30,  windowMs: 60_000 },
