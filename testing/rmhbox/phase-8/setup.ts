/**
 * RMHbox Phase 8 — Test Setup
 *
 * Extends Phase 5 setup with minigame-specific helpers for testing
 * the Phase 8 minigames: Identity Crisis and Ranking File.
 *
 * Environment-agnostic: no real DB, file I/O, or network
...
// ─── Identity Crisis Mock Data ───────────────────────────────────

export const MOCK_IDENTITIES = [
  { id: 'albert-einstein', name: 'Albert Einstein', category: 'Scientist', difficulty: 'easy' as const, hints: ['Known for E=mc²'] },
  { id: 'mickey-mouse', name: 'Mickey Mouse', category: 'Fictional', difficulty: 'easy' as const, hints: ['Disney character'] },
  { id: 'michael-jordan', name: 'Michael Jordan', category: 'Athlete', difficulty: 'easy' as const, hints: ['Basketball legend'] },
  { id: 'cleopatra', name: 'Cleopatra', category: 'Historical', difficulty: 'medium' as const, hints: ['Egyptian queen'] },
  { id: 'beethoven', name: 'Beethoven', category: 'Musician', difficulty: 'medium' as const, hints: ['Classical composer'] },
  { id: 'shakespeare', name: 'William Shakespeare', category: 'Writer', difficulty: 'medium' as const, hints: ['English playwright'] },
  { id: 'da-vinci', name: 'Leonardo da Vinci', category: 'Artist', difficulty: 'medium' as const, hints: ['Renaissance master'] },
  { id: 'gandalf', name: 'Gandalf', category: 'Fictional', difficulty: 'easy' as const, hints: ['Wizard from LOTR'] },
];

// ─── Ranking File Mock Data ──────────────────────────────────────

export const MOCK_CATEGORIES = [
  { id: 'fast-food', name: 'Fast Food Chains', items: ["McDonald's", 'Burger King', "Wendy's", 'Chick-fil-A', 'Taco Bell'], emoji: '🍔', difficulty: 'easy' as const },
  { id: '90s-movies', name: '90s Movies', items: ['Titanic', 'Pulp Fiction', 'The Matrix', 'Forrest Gump', 'Jurassic Park'], emoji: '🎬', difficulty: 'medium' as const },
  { id: 'music-genres', name: 'Music Genres', items: ['Pop', 'Rock', 'Hip-Hop', 'Country', 'Jazz'], emoji: '🎵', difficulty: 'hard' as const },
  { id: 'vacation-types', name: 'Vacation Types', items: ['Beach', 'Mountain', 'City', 'Road Trip', 'Staycation'], emoji: '🏖️', difficulty: 'medium' as const },
  { id: 'pets', name: 'Pets', items: ['Dog', 'Cat', 'Fish', 'Hamster', 'Parrot'], emoji: '🐕', difficulty: 'easy' as const },
  { id: 'social-media', name: 'Social Media', items: ['Instagram', 'TikTok', 'Twitter', 'YouTube', 'Reddit'], emoji: '📱', difficulty: 'easy' as const },
];
