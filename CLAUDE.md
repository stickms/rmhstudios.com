...
| Path           | What                                                                                                                                                                                                                                                                                           | Details                                          |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `app/`         | TanStack Start routes: pages, API routes, `globals.css` (theme tokens: base + curated themes + accent presets; the **radial monochrome** UI is the default — the design language is Radial Liquid Glass, see `docs/design-language.md`), router. `routeTree.gen.ts` is GENERATED — never edit. | [`app/CLAUDE.md`](app/CLAUDE.md)                 |
