  ...
  return (
    <div className={`relative overflow-hidden rounded-site-sm ${className}`}>
      ...
      <button
        ...
        className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 bg-site-bg/70 text-center backdrop-blur-sm transition-colors hover:bg-site-bg/60"
      >
