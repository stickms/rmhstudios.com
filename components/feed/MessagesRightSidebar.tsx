...
function UserRow({ user }: { user: SidebarUser }) {
 ...
 className="flex items-center gap-2.5 px-2 py-1.5 rounded-site-sm hover:bg-site-surface-hover active:scale-[0.99] transition-[background-color,scale] duration-site-fast group"
 >
