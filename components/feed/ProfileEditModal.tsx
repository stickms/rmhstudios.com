...
export function ProfileEditModal({ open, onClose, onSaved, initial }: ProfileEditModalProps) {
 ...
 <span className="flex size-full items-center justify-center bg-linear-to-br from-site-accent-dim via-site-surface to-site-bg-subtle text-site-text-muted">
