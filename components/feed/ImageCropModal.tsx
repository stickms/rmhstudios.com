...
export function ImageCropModal({
 ...
 className="bg-site-surface border border-site-border shadow-site-sm relative flex h-dvh w-dvw max-w-none flex-col overflow-y-auto rounded-none pb-[env(safe-area-inset-bottom)] pt-[env(safe-area-inset-top)] sm:h-auto sm:max-h-[90dvh] sm:w-full sm:max-w-lg sm:rounded-site sm:p-0"
 >
 {/* Header */}
