...
export function ProfileHoverCard({
 ...
 align="start"
 sideOffset={6}
 className="z-[80] w-72 p-4 bg-site-surface border border-site-border rounded-site shadow-site-sm outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95"
 >
 {!profile ? (
