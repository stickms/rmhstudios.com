...
function InviteFriendsCard() {
  ...
  return (
    <section className="bg-site-surface rounded-site p-4 border border-site-border">
      <h2 className="font-(family-name:--site-font-display) font-bold text-lg tracking-[-0.018em] text-site-text flex items-center gap-2 mb-1.5">
...
export function RightSidebar({
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      {/* Official Builds */}
      <section className="bg-site-surface rounded-site p-4 border border-site-border">
        <h2 className="font-(family-name:--site-font-display) font-bold text-lg tracking-[-0.018em] text-site-text flex items-center gap-2 mb-3">
