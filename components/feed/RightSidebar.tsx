...
function OnlineNowPill() {
 ...
 return (
 <div className="flex items-center gap-2 rounded-full border border-site-border bg-site-surface px-3 py-1.5 text-sm text-site-text-muted shadow-[inset_0_1px_0_var(--site-glass-rim-soft)]">
...
function InviteFriendsCard() {
 ...
 return (
 <section className="bg-site-surface border border-site-border rounded-2xl shadow-xs p-4">
...
export function RightSidebar({
 ...
 // gutters between the bg-site-surface border border-site-border rounded-2xl shadow-xs cards.
 ...
 {/* Official Builds */}
 <section className="bg-site-surface border border-site-border rounded-2xl shadow-xs p-5 rounded-tr-[2rem] rounded-bl-[2rem] rounded-tl-xl rounded-br-xl border border-site-border bg-site-surface shadow-sm">
