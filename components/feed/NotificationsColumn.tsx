...
function PreferencesPanel() {
 ...
 return (
 // Floating slab (§8.4): a discrete L1 `.glass-fill` card over the aurora gutter.
 <div className="glass-fill mx-3 mt-3 px-4 py-3">
...
"When someone likes, comments on, reposts, or mentions you, it'll show up here.",
 ...
 // Density page (§8.4): rows stay dense INSIDE one floating L1 `.glass-fill`
 ...
 <Reveal
 as="ul"
 className="glass-fill mx-3 mt-3 divide-y divide-site-border overflow-hidden"
 >
 {groups.map((g) => {
 const n = g.newest;
