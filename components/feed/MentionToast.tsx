...
export function showMentionToast(n: MentionNotification, navigate: NavigateFn) {
 ...
 className="flex items-start gap-3 w-full text-left p-3 bg-site-surface border border-site-border rounded-site shadow-site-sm hover:bg-site-surface-hover transition-colors"
 >
