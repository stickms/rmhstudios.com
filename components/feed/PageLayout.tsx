...
export function PageLayout({
 ...
 {/* Sticky Header — L3 bg-site-surface border border-site-border rounded-2xl shadow-xs floating capsule (§8.2). The shared
 ...
 className={`group bg-site-surface border border-site-border rounded-2xl shadow-xs site-sticky-chrome transition-[height] duration-150 data-[scrolled]:h-14 ${expandedHeaderHeight}`}
 >
