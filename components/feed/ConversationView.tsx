 ...
 * entire inbox client-side just to find them). */
 ...
 {/* Header */}
 <div className="site-sticky-chrome bg-site-surface border border-site-border rounded-2xl shadow-xs shrink-0">
 ...
 <div
 ref={attachPanelRef}
 className="absolute bottom-full right-0 z-30 mb-1 w-40 bg-site-surface border border-site-border rounded-2xl shadow-xs py-1"
 >
 <button
 type="button"
