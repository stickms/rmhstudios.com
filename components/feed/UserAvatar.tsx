...
function UserAvatarImpl({ user, size ='md', linkToProfile = true }: UserAvatarProps) {
 ...
 className="block shrink-0 rounded-full transition-[transform,opacity] duration-150 hover:opacity-90 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-site-accent"
 >
 {avatar}
 </Link>
 );
