...
export function FeedColumn({ initialFeed }: { initialFeed?: Promise<InitialFeed> | null }) {
 ...
 {/* Header — floating L3 bg-site-surface border border-site-border rounded-2xl shadow-xs capsule (§8.2): insets from the
 ...
 own sheet strips below, §5.45). The bg-site-surface border border-site-border rounded-2xl shadow-xs bg + blur + glint edge
 all clip to rounded-site on their own. */}
 <header data-slot="feed-header"className="site-sticky-chrome bg-site-surface border border-site-border rounded-2xl shadow-xs">
 ...
 <div className="bg-site-surface border border-site-border rounded-2xl shadow-xs relative">
 <Search
 ...
 as="section"
 className="bg-site-surface border border-site-border rounded-2xl shadow-xs mx-3 overflow-hidden"
