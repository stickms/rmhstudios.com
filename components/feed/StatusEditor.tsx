...
export function StatusEditor({ initial }: { initial: UserStatus | null }) {
 ...
 className="bg-site-surface border border-site-border rounded-2xl shadow-xs inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-sm text-site-text hover:border-site-text/40"
 >
...
'rounded-full px-3 py-1.5 text-sm transition-colors',
 ...
 :'bg-site-surface border border-site-border rounded-2xl shadow-xs text-site-text-muted hover:border-site-text/40',
 )}
 >
