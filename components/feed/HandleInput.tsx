...
export function HandleInput({ value, onChange, multiple = false, placeholder, className, id, onKeyDown, ...rest }: HandleInputProps) {
 ...
 <div
 ref={popPanelRef}
 className="absolute left-0 right-0 top-full z-50 mt-1 max-h-60 overflow-y-auto bg-site-surface border border-site-border rounded-site shadow-site-sm py-1"
