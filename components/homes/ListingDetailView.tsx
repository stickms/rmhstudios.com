          ...
          <div className="mb-5">
            <div className="relative aspect-[16/9] w-full overflow-hidden rounded-site border border-site-border bg-site-bg">
              ...
              {listing.aiImages.includes(images[activeImage]) && (
                <span className="absolute bottom-3 right-3 inline-flex items-center gap-1 rounded-full bg-site-media-scrim-strong px-2.5 py-1 text-xs font-medium text-site-media-ink ">
                ...
                {images.map((img, i) => (
                  ...
                  >
                    ...
                    {listing.aiImages.includes(img) && (
                      <span className="absolute bottom-0.5 right-0.5 grid h-4 w-4 place-items-center rounded-full bg-site-media-scrim-strong text-site-media-ink">
