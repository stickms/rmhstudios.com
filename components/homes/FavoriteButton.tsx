  ...
  if (compact) {
    return (
      <button
        ...
        className="grid h-9 w-9 place-items-center rounded-full bg-site-media-scrim text-site-media-ink  transition hover:bg-site-media-scrim-hover active:scale-95"
      >
        {busy ? (
