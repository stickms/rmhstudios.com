...
export const journalEntries: JournalEntryData[] = [
    ...
    },
    {
        ...
        act: 'act1',
        category: 'hint',
        title: 'Fragment of a Star Map',
        content: 'A tattered parchment found wedged between roots. It shows a constellation I don\'t recognize — looks like connected stars forming the shape of a tree. The annotation reads: "Connect the bright ones, ignore the decoys. The tree of life watches over these woods."',
        hintLevel: 2,
