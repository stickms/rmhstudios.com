...
export const journalEntries: JournalEntryData[] = [
    ...
    },
    {
        ...
        act: 'act1',
        category: 'history',
        title: 'The Warden\'s First Note',
        content: 'A weatherproof note nailed to a trunk, written in a steady hand: "If you are reading this, the forest let you in, which means it is worse than I feared. I am the last Warden of these woods. I have gone ahead to the Heartwood to do what I can. Wake the stones as you go — the forest remembers best when someone listens. Follow the lanterns. Follow me. — W."',
        hintLevel: 0,
    },
    {
        id: 'act1_hidden_cache',
        act: 'act1',
        category: 'personal',
        title: 'The Warden\'s Cache',
        content: 'Tucked beneath a hollow stone: a tin of lantern oil, a coil of waxed cord, and a child\'s drawing of a great tree with a green heart, signed with a small "W." The Warden was here long enough to make camp. Long enough to miss someone. I take nothing but the knowledge that I am on the right path.',
        hintLevel: 0,
    },
    ...
    {
        id: 'act2_warden_warning',
        act: 'act2',
        category: 'history',
        title: 'The Warden\'s Warning',
        content: 'Another note, hastier than the first: "The shifting is not malice. It is a fever — the forest thrashing in its sleep as the forgetting spreads. Calm the wind, the light, and the echoes, and the fever breaks. Do NOT trust the paths until then; trust the lanterns. I lost two days walking in circles. I do not have two days. — W."',
        hintLevel: 1,
    },
    {
        id: 'act2_hollow_heart',
        act: 'act2',
        category: 'lore',
        title: 'Heart of the Hollow',
        content: 'The great hollow tree did not die — it opened. Generations of wardens carved its heartwood into pipes and chambers so the forest could speak in wind. When the last note of its song is played, they say every tree in the deep wood leans in to listen. Tonight the hollow is silent, and the silence feels like a held breath.',
        hintLevel: 0,
    },
    {
        id: 'act2_calm_returns',
        act: 'act2',
        category: 'personal',
        title: 'A Moment of Calm',
        content: 'For a few minutes after the trees settled, the forest was utterly still. No shifting, no whispers — just the amber dusk and my own heartbeat. I understand now why the Warden kept going. You cannot feel a silence like that and leave the forest to forget itself.',
        hintLevel: 0,
    },
    ...
    {
        id: 'act3_warden_farewell',
        act: 'act3',
        category: 'history',
        title: 'The Warden\'s Farewell',
        content: 'The last note, resting against a moss-grown pack beneath the Heartwood\'s roots: "I gave the forest my years and it gave me its mornings, and it was a fair trade. I could not break the final seal alone — it takes two: one to hold the memory, one to turn the rings. So I will hold. Whoever you are, whenever you come: turn the rings. Finish the song. And if the forest asks you to stay, know that it is not a cage. It is a home offering itself. — W."',
        hintLevel: 0,
    },
    {
        id: 'act3_heartwood_dream',
        act: 'act3',
        category: 'lore',
        title: 'The Heartwood\'s Dream',
        content: 'I touched the bark and the forest showed me a morning from nine hundred years ago: low sun through young trees, a wolf drinking at the creek, someone laughing far away. The Heartwood does not store memories the way a book stores words. It stores them the way you remember being loved — all at once, and warm.',
        hintLevel: 0,
    },
    {
        id: 'act3_new_warden',
        ...
        content: 'The sun is up. The corruption is gone, and the forest is louder than I have ever heard it — birdsong, creek-water, wind through ten thousand remembering leaves. I found a lantern by the Heartwood, freshly oiled, though no one has been here in years. I think it is mine now. I think I will stay a while, and listen.',
        hintLevel: 0,
    },
];
