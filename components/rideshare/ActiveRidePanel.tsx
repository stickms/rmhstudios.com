        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          ...
          {isDriver && status === 'IN_PROGRESS' && (
            <button
              ...
              disabled={busy}
              className="flex items-center justify-center gap-2 rounded-site bg-emerald-500 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-emerald-600 disabled:opacity-50 sm:flex-1 sm:py-2.5"
            >
