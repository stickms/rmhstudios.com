        ...
        <div className="mt-3 space-y-3 rounded-lg border border-site-border bg-site-surface p-3">
          ...
          <div>
            ...
            <input
              ...
              maxLength={40}
              placeholder="Home"
              className="w-full rounded-lg border border-site-border bg-site-bg px-3 py-2 text-sm text-site-text outline-none transition-colors placeholder:text-site-text-dim focus:border-site-accent/60"
            />
          </div>
          <LocationSearch label="Location" value={place} onSelect={setPlace} placeholder="Search for the address" />
          <button
            onClick={save}
            disabled={saving}
