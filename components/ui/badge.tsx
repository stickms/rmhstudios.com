...
/**
 * Shared pill/badge primitive. Consolidates the dozens of inline
 * `inline-flex items-center gap-1 rounded-full …` chips that were scattered
 * across the feed, profile, predictions and shop columns into one
 * token-driven component so every status/label pill looks the same.
 */
