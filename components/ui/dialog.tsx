    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'glass-overlay fixed left-1/2 top-1/2 z-50 grid max-h-[85dvh] w-[calc(100dvw-1rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto p-4 text-site-text sm:w-full sm:p-6',
          mobileFullscreen &&
      ...
      >
        ...
        <DialogPrimitive.Close
          className={cn(
            'absolute right-4 rounded-full p-1.5 text-site-text-muted opacity-80 transition-opacity hover:opacity-100 hover:bg-site-surface-hover outline-none focus-visible:ring-2 focus-visible:ring-site-accent/50 disabled:pointer-events-none sm:top-4',
