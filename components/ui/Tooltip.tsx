...
export function Tooltip({ content, children, className, delay = 0.2 }: TooltipProps) {
 ...
 // Floating UI → L4 bg-site-surface border border-site-border shadow-lg, with the small radius.
 "bg-site-surface border border-site-border shadow-lg !rounded-2xl",
 className
 )}
 >
 {content}
