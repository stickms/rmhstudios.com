...
export function HorizontalScroller({
 ...
 className="glass-overlay shadow-site absolute left-2 top-1/2 z-2 hidden size-9 -translate-y-1/2 items-center justify-center rounded-full text-site-text opacity-0 transition-opacity hover:text-site-accent focus-visible:opacity-100 group-hover/scroll:opacity-100 sm:flex"
 >
 ...
 className="glass-overlay shadow-site absolute right-2 top-1/2 z-2 hidden size-9 -translate-y-1/2 items-center justify-center rounded-full text-site-text opacity-0 transition-opacity hover:text-site-accent focus-visible:opacity-100 group-hover/scroll:opacity-100 sm:flex"
 >
