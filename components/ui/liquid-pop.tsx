 ...
 * breaks backdrop sampling; `.bg-site-surface border border-site-border shadow-lg` panels blur their backdrop, so the
 ...
 * `.bg-site-surface border border-site-border shadow-lg` panel crossfades in on top and shares the bud's progress:
 ...
 * consumer keeps its existing open state, trigger button, and `.bg-site-surface border border-site-border shadow-lg`
...
export interface LiquidPopOptions {
 ...
 /** The floating `.bg-site-surface border border-site-border shadow-lg` panel (mounted while `open`). */
