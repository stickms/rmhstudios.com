...
| `feed/`         | Feed/timeline plus the **layout system**: `SiteShell.tsx` (site-wide chrome), `PageLayout.tsx` (canonical page wrapper), `ContextRail.tsx`, `AnimatedMain.tsx`, `LeftSidebar`, `MobileSidebarShell` (mobile drawer), post cards, composer. Also `feed.css`.                                                                                                                                    |
