...
const socialLinks = [
  ...
  { name: "Reddit", href: "https://reddit.com/r/rmhstudios", icon: RedditIcon },
];

export function FooterSection() {
  return (
    <footer id="contact" className="relative min-h-screen flex flex-col justify-center px-4 py-20 pb-28 md:pb-20">
