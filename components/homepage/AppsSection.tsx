...
export function AppsSection() {
  return (
    <section id="apps" className="relative min-h-screen flex flex-col pt-20 overflow-hidden bg-gradient-to-b from-black via-[var(--neon-purple)]/10 to-black">
      {/* Subtle Divider */}
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[var(--neon-purple)]/50 to-transparent opacity-50" />

      {/* Background Ambience */}
      <div className="absolute inset-0 to-[var(--neon-purple)]/10 pointer-events-none" />
