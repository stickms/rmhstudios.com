            ...
            {recentlyUnlocked && (
                ...
                >
                    <div className="flex items-center gap-3 bg-black/90 border border-yellow-400/60 rounded-lg px-4 py-3 shadow-2xl backdrop-blur-md min-w-[280px]">
                        {/* Gold accent bar */}
                        <div className="w-1 h-12 bg-gradient-to-b from-yellow-300 to-yellow-600 rounded-full flex-shrink-0" />

                        {/* Icon */}
                        <div className="text-3xl flex-shrink-0">{recentlyUnlocked.icon}</div>
