...
function Toolbar() {
  ...
  const views: {
  ...
  }[] = [
    {
      id: 'arrangement',
      icon: Music4,
      label: t('view-arrangement', { defaultValue: 'Arrangement' }),
      shortcut: '1',
    },
    {
      id: 'pianoRoll',
      icon: Piano,
      label: t('view-piano-roll', { defaultValue: 'Piano Roll' }),
      shortcut: '2',
    },
    {
      id: 'mixer',
      icon: SlidersHorizontal,
      label: t('view-mixer', { defaultValue: 'Mixer' }),
      shortcut: '3',
    },
    {
      id: 'pattern',
      icon: Grid3X3,
      label: t('view-pattern', { defaultValue: 'Pattern' }),
      shortcut: '4',
    },
  ];
  ...
  const tools: {
  ...
  }[] = [
    {
      id: 'select',
      icon: MousePointer2,
      label: t('tool-select', { defaultValue: 'Select' }),
      shortcut: 'V',
    },
    ...
    { id: 'erase', icon: Eraser, label: t('tool-erase', { defaultValue: 'Erase' }), shortcut: 'E' },
    {
      id: 'slice',
      icon: Scissors,
      label: t('tool-slice', { defaultValue: 'Slice' }),
      shortcut: 'S',
    },
    ...
    <div className="flex items-center gap-1 border-b border-[var(--site-border)] bg-[var(--site-surface)] px-3 py-1.5">
      ...
      <button
        ...
        className={`rounded px-2 py-1 text-xs ${
          snapEnabled
            ? 'bg-cyan-500/20 text-cyan-400'
            : 'text-[var(--site-muted)] hover:bg-white/10'
        }`}
      >
      ...
      <Select
        ...
        className="w-auto"
        aria-label={t('snap-value', { defaultValue: 'Snap value' })}
      ...
      <div className="flex h-6 items-center justify-between border-t border-[var(--site-border)] bg-[var(--site-surface)] px-3">
        <div className="flex items-center gap-3 text-[10px] text-[var(--site-muted)]">
          <span className={engineReady ? 'text-green-400' : 'text-yellow-400'}>
            {engineReady
              ? t('audio-ready', { defaultValue: 'Audio Ready' })
              : t('click-to-init-audio', { defaultValue: 'Click to initialize audio' })}
          </span>
        </div>
