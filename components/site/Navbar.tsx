            ...
            <div className="ml-10 flex items-center space-x-4">
              {links.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors font-mono uppercase tracking-wider ${
                    pathname === link.href
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {links.map((link) => (
              <Link
                ...
                className={`block px-3 py-2 rounded-md text-base font-medium font-mono uppercase ${
                  pathname === link.href
