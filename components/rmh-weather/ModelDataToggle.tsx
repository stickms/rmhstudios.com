...
export const ModelDataToggle = () => {
  ...
  return (
    <div className="my-8">
      <div className="text-lg font-semibold text-gray-400 mb-2">Model Data Toggle</div>
      ...
      <div className="mt-4 text-xs text-gray-500">Demo: Toggle between weather models (mock data).</div>
    </div>
  );
};
