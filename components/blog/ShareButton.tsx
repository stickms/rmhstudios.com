...
export function ShareButton({ slug, className }: ShareButtonProps) {
 ...
 <button
 onClick={handleShare}
 className={`p-2 rounded-full bg-black/60 text-white/70 hover:text-(--neon-cyan) hover:bg-black/80 active:scale-95 transition-[transform,color,background-color] duration-150 border border-white/10 flex items-center justify-center ${className ||""}`}
