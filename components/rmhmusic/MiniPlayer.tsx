...
function MiniPlayerInner() {
  ...
  return (
    <div
      className="fixed bottom-16 left-2 right-2 z-40 mx-auto max-w-sm overflow-hidden rounded-site border border-site-border bg-site-surface shadow-[var(--site-shadow)] md:bottom-4 md:left-auto md:right-4"
      role="region"
