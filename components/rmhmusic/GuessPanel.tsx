    ...
    <AnimatePresence>
      {isGuessOpen && (
        <motion.div
          ...
          className="fixed right-0 top-0 bottom-[calc(73px+var(--safe-bottom))] z-40 flex w-80 max-w-full flex-col overflow-hidden pt-[var(--safe-top)] backdrop-blur-xl border-l"
