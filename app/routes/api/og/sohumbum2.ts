...
import { buildDayCard, buildOverviewCard } from '@/lib/sohumbum2/og.server';

/**
 * GET /api/og/sohumbum2 — the unfurl card for the dossier and for one day of it.
 *
 ...
 */
export const Route = createFileRoute('/api/og/sohumbum2')({
  server: {
    handlers: {
      GET: defineHandler(
        {
