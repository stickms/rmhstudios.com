...
import { DEFAULT_HISTORY_DAYS, MAX_HISTORY_DAYS } from '@/lib/sohumbum2/config';

/**
 * GET /api/sohumbum2/activity — the whole dossier, and what the page polls.
 *
 ...
 */
export const Route = createFileRoute('/api/sohumbum2/activity')({
  server: {
    handlers: {
      GET: defineHandler(
        {
