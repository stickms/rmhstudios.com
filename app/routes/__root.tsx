 ...
 * ## `data-app-dark`
 *
 * For a game in `APP_ROUTE_THEME_BG` the script already parses that game's own
 ...
 * root the right colour is only half the problem: the game's own token block is
