...
function SiteLayout() {
  return (
    <div className="vibe-app min-h-dvh bg-site-bg flex flex-col md:flex-row">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-lg focus:bg-site-accent focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-white"
      >
        Skip to content
      </a>
      <WelcomeModal />
