  ...
  return (
    <main className="min-h-screen bg-[#050505] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full p-4 z-50 flex justify-between items-center pointer-events-none">
        ...
        {/* Back Button */}
        <Link href="/games" className="pointer-events-auto flex items-center gap-2 text-slate-400 hover:text-white transition-colors group bg-slate-900/50 p-2 rounded-lg backdrop-blur-sm border border-slate-700/50 hover:border-slate-500">
